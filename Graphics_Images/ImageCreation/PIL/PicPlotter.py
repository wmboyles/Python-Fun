...
I would reccomend using x and y in some way as parameters for R, G, and B.
Many of these functions need to be optomized to run faster, especially for large
